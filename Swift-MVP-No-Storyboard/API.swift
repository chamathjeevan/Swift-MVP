...
public final class GitProfileQuery: GraphQLQuery {
    ...
    public struct Viewer: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLField("pinnedItems", arguments: ["first": 5, "types": "REPOSITORY"], type: .nonNull(.object(PinnedItem.selections))),
          GraphQLField("topRepositories", arguments: ["orderBy": ["field": "CREATED_AT", "direction": "ASC"], "last": 10], type: .nonNull(.object(TopRepository.selections))),
      ...
      public init(name: String? = nil, avatarUrl: String, email: String, company: String? = nil, bio: String? = nil, followers: Follower, following: Following, pinnedItems: PinnedItem, topRepositories: TopRepository, starredRepositories: StarredRepository) {
        self.init(unsafeResultMap: ["__typename": "User", "name": name, "avatarUrl": avatarUrl, "email": email, "company": company, "bio": bio, "followers": followers.resultMap, "following": following.resultMap, "pinnedItems": pinnedItems.resultMap, "topRepositories": topRepositories.resultMap, "starredRepositories": starredRepositories.resultMap])
      }
      ...
      public struct PinnedItem: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeRepository(name: String, description: String? = nil, url: String, stargazerCount: Int, primaryLanguage: AsRepository.PrimaryLanguage? = nil) -> Node {
            return Node(unsafeResultMap: ["__typename": "Repository", "name": name, "description": description, "url": url, "stargazerCount": stargazerCount, "primaryLanguage": primaryLanguage.flatMap { (value: AsRepository.PrimaryLanguage) -> ResultMap in value.resultMap }])
          }
          ...
          public struct AsRepository: GraphQLSelectionSet {
            ...
            public init(name: String, description: String? = nil, url: String, stargazerCount: Int, primaryLanguage: PrimaryLanguage? = nil) {
              self.init(unsafeResultMap: ["__typename": "Repository", "name": name, "description": description, "url": url, "stargazerCount": stargazerCount, "primaryLanguage": primaryLanguage.flatMap { (value: PrimaryLanguage) -> ResultMap in value.resultMap }])
            }
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public struct PrimaryLanguage: GraphQLSelectionSet {
            ...
            public init(id: GraphQLID, name: String) {
              self.init(unsafeResultMap: ["__typename": "Language", "id": id, "name": name])
            }
