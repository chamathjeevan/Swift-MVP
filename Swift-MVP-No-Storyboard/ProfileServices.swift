...
class ProfileServices: ProfileServicesProtocol {
    func fetchProfile(completion: @escaping (Result<Profile, Error>) -> Void) {
        let url = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Angelina_Jolie_2_June_2014_%28cropped%29.jpg/440px-Angelina_Jolie_2_June_2014_%28cropped%29.jpg"
